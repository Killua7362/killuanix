...
| `layout.nix` | Layout engines: dwindle (preserve split, pseudotile), scrolling (`explicit_column_widths = "1.0, 0.5"`, `column_width = 1.0` default spawn, `fullscreen_on_one_column = true`), master, decoration (rounding 8, blur, shadows), cursor, and bind scroll settings. |
