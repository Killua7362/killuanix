{lib, ...}: {
  wayland.windowManager.hyprland.settings = {
    windowrule = [
      ...
      "size 525 300, match:class firefox-nightly, match:title Picture-in-Picture"
      "move 1380 80, match:class firefox-nightly, match:title Picture-in-Picture"
      "float 1, match:title satty"
      "center 1, match:title satty"
      ...
      "size 45%, match:class com.saivert.pwvucontrol"
      "center 1, match:class com.saivert.pwvucontrol"
      "float 1, match:class org-jdownloader-update-launcher-JDLauncher"
      "size 60%, match:class org-jdownloader-update-launcher-JDLauncher"
      "center 1, match:class org-jdownloader-update-launcher-JDLauncher"
      ...
      "immediate 1, match:class ^(kodi).*"
      "no_blur 1, match:class ^(kodi).*"
      "no_shadow 1, match:class ^(kodi).*"
