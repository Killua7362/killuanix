...
| File | Description |
|---|---|
| `default.nix` | Aggregator that imports `opencode.nix`, `claude.nix`, `claude-resources.nix`, `claude-kit.nix`, `ruflo-cli.nix`, `claude-flow-cli.nix`, `ccr.nix`, `ccmanager.nix`, `code-index.nix`, and `jupyter-env-mcp.nix`. |
