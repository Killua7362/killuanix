    ...
    config = function(_, opts)
      ...
      if LazyVim.has("mason.nvim") then
        ...
        if opts.dap and LazyVim.has("nvim-dap") and mason_registry.is_installed("java-debug-adapter") then
          bundles = vim.fn.glob("~/.local/share/nvim/mason/packages/java-debug-adapter/extension/server/com.microsoft.java.debug.plugin-*.jar", false, true)
          -- java-test also depends on java-debug-adapter.
          if opts.test and mason_registry.is_installed("java-test") then
              local java_test_bundles = vim.fn.glob("~/.local/share/nvim/mason/packages/java-test/extension/server/*.jar", false, true)
